...
<div class="container" style="margin-top: 51px;">
  <button class="btn btn-close text-dark" style="color: white" onclick="window.location.href='commandes.php'"></button>
  <br>
  <br>
  <div class="table-responsive">
    <table class="table table-responsive-md">
      ...
      <tr>
        ...
        <td>2020-09-16</td>
        <td>en cours</td>
        <td><a href="" style="text-decoration: none;">Détails</a> &nbsp; <a href="" style="text-decoration: none;">Supprimer</a></td>
      </tr>
    </table>
  </div>
</div>
