...
<?php 
    ...
    if ($_GET["id"]) {
        ...
        $res = $administrateur->oneAdministrateur();
    }
...
<center>
  <span><h5 style="font-weight: bold;">Modification d'un administrateur</h5></span>
</center>
<div class="table-responsive">
  <form action="../Controllers/Administrateur.php" method="post" style="margin-bottom:50px">
      ...
      <input type="text" name="nom" id="nom" required placeholder="nom - post - prenom" class="form-control" value="<?=$res["nom"] ?>"><br>
      <label for="email">Email</label><br>
      <input type="email" name="email" id="email" required placeholder="exemple@gmail.com" class="form-control" value="<?=$res["email"] ?>"><br>
      <label for="passwd">Password</label><br>
      <input type="text" name="passwd" id="passwd" required placeholder="*******" class="form-control" value="<?=$res["passwd"] ?>"><br>
